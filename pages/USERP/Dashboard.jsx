    ...
    <div className="min-h-screen bg-[#f4f6f8] p-6">
      ...
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <img src="/avatar.png" alt="Admin avatar" className="w-10 h-10 rounded-full" />
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Visits Today */}
        <div className="bg-white rounded-2xl shadow-md p-6 col-span-2 flex justify-between">
          <div>
        ...
        {/* Targeting by Region */}
        <div className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Targeting by Region</h2>
